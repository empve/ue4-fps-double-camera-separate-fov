...
UNREALROOTPATH = /home/weining/work/dev/cxx/github.com/EpicGames/ue5/5.0.3
GAMEPROJECTFILE =/home/weining/work/tmp/repo/ue4-fps-double-camera-separate-fov/FovTutorial.uproject
...
TARGETS = \
	...
	UnrealServer \
	FovTutorial-Linux-Debug  \
	FovTutorial-Linux-DebugGame  \
	FovTutorial-Linux-Test  \
	FovTutorial-Linux-Shipping  \
	FovTutorial \
	FovTutorialEditor-Linux-Debug  \
	FovTutorialEditor-Linux-DebugGame  \
	FovTutorialEditor-Linux-Test  \
	FovTutorialEditor-Linux-Shipping  \
	FovTutorialEditor\
	configure
...
FovTutorial-Linux-Debug:
	 $(PROJECTBUILD) FovTutorial Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FovTutorial-Linux-DebugGame:
	 $(PROJECTBUILD) FovTutorial Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FovTutorial-Linux-Test:
	 $(PROJECTBUILD) FovTutorial Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FovTutorial-Linux-Shipping:
	 $(PROJECTBUILD) FovTutorial Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FovTutorial:
	 $(PROJECTBUILD) FovTutorial Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

FovTutorialEditor-Linux-Debug:
	 $(PROJECTBUILD) FovTutorialEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FovTutorialEditor-Linux-DebugGame:
	 $(PROJECTBUILD) FovTutorialEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FovTutorialEditor-Linux-Test:
	 $(PROJECTBUILD) FovTutorialEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FovTutorialEditor-Linux-Shipping:
	 $(PROJECTBUILD) FovTutorialEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FovTutorialEditor:
	 $(PROJECTBUILD) FovTutorialEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
